...
async def get_announcement(
    ...
    if current_user.get("role") not in announcement.get("recipients", []):
...
async def mark_all_as_read(
    ...
    result = notifications_service.mark_all_as_read(current_user.get("email"))
    return result
...
async def get_stats(
    ...
    stats = notifications_service.get_notification_stats(current_user.get("email"))
    return stats
