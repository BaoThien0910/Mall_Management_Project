...
function staffMenuKey(pathname) {
  if (pathname.startsWith('/staff/finance')) return '/staff/finance';
  return pathname;
}
...
export default function StaffLayout() {
  ...
  const sidebarContent = (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', backgroundColor: '#fff' }}>
      ...
      <Menu
        mode="inline"
        selectedKeys={[staffMenuKey(location.pathname)]}
        items={menuItems}
